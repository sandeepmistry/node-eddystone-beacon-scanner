...
EddystoneBeaconScanner.prototype.isUidBeacon = function(peripheral) {
...
EddystoneBeaconScanner.prototype.isUriBeacon = function(peripheral) {
  var serviceData = peripheral.advertisement.serviceData;
...
EddystoneBeaconScanner.prototype.parseUriBeacon = function(peripheral) {
  var data = peripheral.advertisement.serviceData[0].data;
